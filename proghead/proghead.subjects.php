...
<?php include('proghead.sidebar.php'); ?>
    <section class="home-section">
        <div class="home-content">
            ...
            <span class="text"> &nbsp &nbsp &nbsp Subjects</span>
        </div>
...
?></th>
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()){
                        ...
                        <td>$row[courseName]</td>
                         ...
                         if (checkRole('admin') || checkRole('registrar')) {
                             echo "
                          <a href='../crud/editsub.php?subject_id=$row[subject_id]' class='btn'> <i class='bx bx-edit'></i>&nbspEdit</a>
                          <a href='../crud/delsub.php?subject_id=$row[subject_id]' class='btn'><i class='bx bxs-minus-circle'></i>&nbspDelete</a>
                          ";
                        }
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="../crud/addsub.php" method="post">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                <select name="course" id="course" onchange="showSemester()" class="form-control">
                                <?php
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                <select name="prof" id="prof" onchange="showSemester()" class="form-control">
                                <?php
                                             while( $rows = mysqli_fetch_array($req)){
                                             ?>
                                <option value="<?php echo $rows['profName']; ?>"><?php echo $rows['profName'];?>
                                </option>
                                <?php
                                                  }
                                             ?>
        ...
        ?>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="add_sub" class="btn btn-primary">Add Subject</button>
                            </div>
                    </div>
                </div>
            </div>
